...
struct ts4200Pin {
	...
	PinMode FUNC(ModeGet)(ts4200Pin *me,int pin);
	int FUNC(ModeSet)(ts4200Pin *me,int pin,PinMode mode);
	int InitStatus;
	unsigned LockBase;
	int deferlock;
	Bus *syscon;
...
PinMode ts4200PinModeGet(ts4200Pin* ob,int pin);
int ts4200PinModeSet(ts4200Pin* ob,int pin,PinMode mode);
#endif
