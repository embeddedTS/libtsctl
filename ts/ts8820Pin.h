...
struct ts8820Pin {
	...
	PinMode FUNC(ModeGet)(ts8820Pin *me,int pin);
	int FUNC(ModeSet)(ts8820Pin *me,int pin,PinMode mode);
	int InitStatus;
	unsigned LockBase;
	int deferlock;
	int deferlockR;
...
PinMode ts8820PinModeGet(ts8820Pin* ob,int pin);
int ts8820PinModeSet(ts8820Pin* ob,int pin,PinMode mode);
#endif
