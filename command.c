      ...
      case 'T':case 't':
        ...
        case 'I':case 'i':
          ...
          case 'M':case 'm':
            ...
            case 'E':case 'e':
              switch (*str++) {
              case 'H':case 'h': return 21;
              case 'S':case 's': return 20;
              }
              break;
            }
            break;
...
ArrayAuto(void *,SystemBuildTimeArgs,ARR());
...
ArrayAuto(char*,SystemBuildTimeArgNames,ARR());
...
ArrayAuto(char*,SystemBuildTimeRetNames,ARR("",));
